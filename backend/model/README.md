...
2. Use new_predict.py to get predictions from teacher model and combine with original training data.
3. Train student model with the same finetune.py using training data.
4. For multiple rounds, split the unlabelled data accordingly and repeat steps 2 and 3.
